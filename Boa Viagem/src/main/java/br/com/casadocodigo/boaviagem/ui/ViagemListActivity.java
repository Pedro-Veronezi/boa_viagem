...
import br.com.casadocodigo.boaviagem.ui.GastoActivity_;
import br.com.casadocodigo.boaviagem.R;
import br.com.casadocodigo.boaviagem.ui.ViagemActivity_;
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        ...
        switch (i){
            case 0:
                ...
                break;
            case 1:
                intent = new Intent(this, GastoActivity_.class);
                intent.putExtra(Constantes.VIAGEM_ID, id);
                startActivity(intent);
                break;
            case 2:
