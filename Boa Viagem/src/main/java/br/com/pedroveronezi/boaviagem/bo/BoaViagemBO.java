package br.com.pedroveronezi.boaviagem.bo;
...
import br.com.pedroveronezi.boaviagem.dao.BoaViagemDAO;
...
public class BoaViagemBO {
    ...
    public boolean removerGasto(long id) {
        return boaViagemDAO.removerGasto(id);
    }
