...
*/
    ...
    protected Dialog onCreateDialog(int id){
        if(R.id.dataChegadaButton == id){
            return new DatePickerDialog(this,  R.style.AppTheme, dataChegadaDialog, dataChegada.get(Calendar.YEAR), dataChegada.get(Calendar.MONTH), dataChegada.get(Calendar.DAY_OF_MONTH));
        }else if(R.id.dataSaidaButton == id){
            return new DatePickerDialog(this,  R.style.AppTheme, dataSaidaDialog, dataSaida.get(Calendar.YEAR), dataSaida.get(Calendar.MONTH), dataSaida.get(Calendar.DAY_OF_MONTH));
        }
        return null;
